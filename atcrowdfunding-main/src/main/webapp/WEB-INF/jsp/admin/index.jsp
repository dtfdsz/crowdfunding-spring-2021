              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
				      ...
				      <button type="button" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil" onclick="window.location.href='${PATH}/admin/toUpdate?pageNum=${page.pageNum }&id=${admin.id }'"></i></button>
        ...
        <script type="text/javascript">
            ...
            $("#selectAll").click(function(){
           	...
           	$("#deleteBatchBtn").click(function(){
           		...
           		layer.confirm("确认批量删除？",{btn:['确定','取消']},function(index){
